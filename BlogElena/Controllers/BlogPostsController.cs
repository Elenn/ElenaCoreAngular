...
using BlogElena.Models;
using BlogElena.Data;

namespace BlogElena.Controllers
{
    ...
    {
        private readonly BlogElenaContext _context;
        private readonly IDataRepository<BlogPost> _repo;

        public BlogPostsController(BlogElenaContext context, IDataRepository<BlogPost> repo)
        {
            _context = context;
            _repo = repo;
        }
